  ...
  private createTables(): void {
    this.db.exec(`
      CREATE TABLE IF NOT EXISTS games (
        ...
        gog_archive_hash TEXT,
        gog_archive_path TEXT,
        gog_archive_size TEXT,
        xbox_archive_hash TEXT,
        xbox_archive_path TEXT,
        xbox_archive_size TEXT,
        uplay_archive_hash TEXT,
        uplay_archive_path TEXT,
        uplay_archive_size TEXT,
        ea_archive_hash TEXT,
        ea_archive_path TEXT,
        ea_archive_size TEXT,
        steam_linux_archive_hash TEXT,
        steam_linux_archive_path TEXT,
        steam_linux_archive_size TEXT,
